...
const timelineEvents = [
  ...
  },
  {
    ...
    title: "Finals Sprint",
    description:
      "More open-ended time to pursue solo and collaborative projects aimed towards the final showcase.",
  },
  {
    date: "Mar 16 - 22",
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mt-6">
                  We believe everyone should know how to build their own
                  personal AIs that help them live, learn, and thrive in a place
                  like Mars. That self-reliance extends to technology; we learn
                  how these tools work to master new domains and bring ambitious
                  projects to life.
                </p>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">
                  The Creative AI school is a 6-week crash course on applying AI
                  tools to personal research, art, and learning. The course
                  specializes in creative agents, AI assistants that produce
                  art, film, music, and other creative media. We explore how to
                  collaborate with these agents, guiding them to generate novel
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
                <div className="text-center p-6 border rounded-lg bg-white shadow-md">
                  ...
                  <p className="text-gray-600">
                    A bootcamp / nocode engineering school where we learn to
                    build computer applications with an ease previously
                    available only to software engineers.
                  </p>
                </div>
                <div className="text-center p-6 border rounded-lg bg-white shadow-md">
                  <div className="flex justify-center mb-4">
                  ...
                  <p className="text-gray-600">
                    A filmmaker co-op focused on using generative AI towards
                    making films, commercials, and other media. The academy will
                    produce the 4th annual Mars Film Festival.
                  </p>
                </div>
                <div className="text-center p-6 border rounded-lg bg-white shadow-md">
                  <div className="flex justify-center mb-4">
                  ...
                  <p className="text-gray-600">
                    A focused game development and playtesting group exploring
                    the possibilities of generative AI in digital and physical
                    games.
                  </p>
                </div>
              </div>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">
                  We build our own auditorium, gallery, library, and other
                  common spaces that Martians can own and activate for
                  workshops, installations, and community events.
                </p>
              </div>
              ...
              <div className="text-center mb-32">
                <div className="inline-block bg-black/60 backdrop-blur-sm p-6 rounded-xl">
                  ...
                  <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                    The semester culminates in a multi-day festival of
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 overflow-hidden flex flex-col">
                  <div
                    ...
                    onClick={() =>
                      setLightboxIndex(academicsGalleryImages.length + 0)
                    }
                  >
                    <Image
                      src="/images/electronica/film-festival.jpg"
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <p className="text-gray-300">
                      prepared by Martians for final exhibition
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 overflow-hidden flex flex-col">
                  <div
                    className="relative h-56 w-full cursor-pointer group overflow-hidden"
                    onClick={() =>
                      setLightboxIndex(academicsGalleryImages.length + 1)
                    }
                  >
                    <Image
                      src="/images/electronica/gallery.jpeg"
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <p className="text-gray-300">
                      4th annual experimental AI film festival
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 overflow-hidden flex flex-col">
                  <div
                    className="relative h-56 w-full cursor-pointer group overflow-hidden"
                    onClick={() =>
                      setLightboxIndex(academicsGalleryImages.length + 2)
                    }
                  >
                    <Image
                      src="/images/electronica/live-events.jpg"
