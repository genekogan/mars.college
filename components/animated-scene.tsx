  ...
  return (
    ...
    >
      <Image
        ...
        style={{ objectPosition: `${OBJECT_POSITION_X * 100}% ${OBJECT_POSITION_Y * 100}%` }}
      />
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-start pt-32 lg:pt-40 text-left">
        <div className="container px-4 lg:px-6 max-w-3xl">
          <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ textShadow: "2px 2px 8px rgba(0,0,0,0.7)" }}>
            Join us on Mars
          </h2>
          <p className="text-xl mb-8 max-w-2xl text-gray-200" style={{ textShadow: "1px 1px 6px rgba(0,0,0,0.7)" }}>
            Applications for 2026 are now open. Propose an academic program, a structure, or a service and join us in
            building our world.
          </p>
